...
CREATE TABLE serenitea_farms_poids_min_bonus_malus (
    id_ceuilleur VARCHAR(10),
    date DATE DEFAULT NULL,
    poids_min DOUBLE DEFAULT 1,
    bonus DOUBLE DEFAULT 0,
    malus DOUBLE DEFAULT 0,
    Foreign Key serenitea_farms_poids_min_bonus_malus(id_ceuilleur) REFERENCES serenitea_farms_ceuilleurs(id_ceuilleur)
);

CREATE TABLE serenitea_farms_categories_depenses (
    nom_depense VARCHAR(100) PRIMARY KEY
);
