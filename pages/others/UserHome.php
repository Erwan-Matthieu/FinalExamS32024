    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    ...
                    <div class="sidebar-brand-text mx-3"><span>GESTION</span></div>
                </a>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
              ...
              <div class="container">
                <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                  <p class="col-md-4 mb-0 text-body-secondary">&copy; Mpiara miasa mavitrika  </p>
              
                  <ul class="nav col-md-4 justify-content-end">
                    <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">Erwan 003024</a></li>
                    <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">Sitraka 002402</a></li>
                    <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">Romeo 002433 </a></li>
                  </ul>
                </footer>
              </div>
