...
if (isset($_POST['reference']) && isset($_POST['area']) && isset($_POST['variety'])) {
    ...
    if (isVarietyExists($pdo,$name)) {
        ...
        $sql_insert = "INSERT INTO serenitea_farms_parcelles (, occupation, rendement) VALUES (:variete, :occupation, :rendement)";
